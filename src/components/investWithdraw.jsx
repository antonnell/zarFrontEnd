...
class InvestWithdraw extends Component {
    ...
    return (
      <Grid container justify="space-around" alignItems="flex-start" direction="row" style={{ width: '100%' }} >
        <Grid item xs={10} md={11} align="left" style={{ marginTop: '24px' }}>
          <Typography>Withdraw saved ZAR to your XAR wallet.</Typography>
        </Grid>
        <Grid item xs={10} md={5} align="left">
          ...
          <div style={{ marginTop: '60px' }}>
            { this.renderInput("Withdraw Amount", amountValue, amountError, amountErrorMessage, onChange, disabled, 'amountValue', 'ZAR') }
          </div>
        </Grid>
        <Grid item xs={10} md={5} align="left">
