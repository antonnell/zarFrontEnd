    ...
    return (
      <Grid
        ...
        <Grid item xs={10} style={classes.header}>
          <Typography variant="h2" style={ classes.title }>Withdraw Collateral</Typography>
        </Grid>
        <Grid item xs={2} align="right">
          <CloseIcon onClick={onClose} style={ classes.closeButton }/>
        </Grid>
        <Grid item xs={12} style={ classes.sepperate }>
          <Typography variant="body1" style={{ color: "#FFF" }}>How much FTM would you like to withdraw?</Typography>
          <CustomTextField
            margin="normal"
            variant="outlined"
            ...
            helperText={"Min. "+ collateralDenom.toUpperCase() +" available: "+minCollateral+" "+ collateralDenom.toUpperCase() }
          />
        </Grid>
        <Grid item xs={12} style={ classes.sepperate }>
