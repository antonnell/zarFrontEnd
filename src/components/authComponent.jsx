    ...
    return (
      ...
      >
        <Grid item xs={8} md={6} align='left'>
          ...
          <Typography variant="body1" style={ { marginTop: '24px', lineHeight: '35px', fontSize: '15px' } }>Enter the 6 digit code that Google Authenticator generates for your XAR account</Typography>
